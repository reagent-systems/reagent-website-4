...
<svelte:head>
	<title>plan - reagent systems</title>
	<meta name="description" content="how we work at reagent systems: long-term exploration, interdisciplinary collaboration, and autonomous inquiry in AI, computer science, and emerging technologies." />
</svelte:head>

<div class="plan-page" class:mounted>
...
<style>
	...
	.plan-page.mounted .plan-section:nth-child(1) {
		transition-delay: 0.1s;
		opacity: 1;
		transform: translateX(0);
	}

	.plan-page.mounted .plan-section:nth-child(2) {
		transition-delay: 0.2s;
		opacity: 1;
		transform: translateX(0);
	}

	.plan-page.mounted .plan-section:nth-child(3) {
		transition-delay: 0.3s;
		opacity: 1;
		transform: translateX(0);
	}

	.plan-page.mounted .plan-section:nth-child(4) {
		transition-delay: 0.4s;
		opacity: 1;
		transform: translateX(0);
	}

	.plan-page.mounted .plan-section:nth-child(5) {
